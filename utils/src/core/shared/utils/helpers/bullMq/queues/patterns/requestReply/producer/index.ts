...
import { ReplyMessageBullMq, RequestReplyMessageBullMq, SendReceiverMessageBullMq } from '../../../../types';
...
export class RequestReplyProducerBullMq {
  ...
  public async sendAsync<TRequest, TResponse>( jobName: string, data: RequestReplyMessageBullMq<TRequest>): Promise<ReplyMessageBullMq<TResponse>> {
