...
export class SenderReceiverConsumerBullMq {
	...
	public async startConsumingAsync<T>(
		queueName: string,
    job?: string | URL | Processor<SendReceiverMessageBullMq<T>, any, string>,
	): Promise<Worker<SendReceiverMessageBullMq<T>, any, string>> {
